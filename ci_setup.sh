...
printf '\n'
printf '\n'
zip -r -X ./tests/Export/artifacts.zip ./ci_run.sh ./tests/Export/html5/web/ ./tests/Export/android/soundExample/build/outputs/apk/soundExample-release.apk ./tests/Export/ios/build/Release-iphonesimulator/soundExample.app